...
\begin{frame}{Learning Multilevel Optimization for BEXLP}
	...
	\begin{itemize}
		\itemsep2ex
		\item We \important{learned neural networks to approximate the expected loss in solution quality} when
		\begin{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\begin{tikzpicture}[remember picture,overlay]
		\node[anchor=south east,xshift=-6mm,yshift=0mm,align=center] at (current page.south east) {\includegraphics[width=0.3\textwidth]{graphics/lns.png}};
	\end{tikzpicture}
\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\itemsep3ex
		\item \structure{Key-feature:} an \important{efficient algorithm to insert charging station visits into routes on-the-fly}
	...
	\begin{itemize}
		...
		\item Our LNS only achieves \alert{few iterations within time-limit, gaps $\approx$10--30\%} 
		\item \important{\bf How to scale up the LNS?}
	\end{itemize}
